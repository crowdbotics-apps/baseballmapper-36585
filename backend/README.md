...
## Project Structure
    ...
    ├── baseballmapper_36585  # Django project configurations
...
1. Clone this repo and `cd baseballmapper_36585`
...
2. Clone this repo and `cd baseballmapper_36585`
